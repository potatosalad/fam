...
This browser implementation does not claim arbitrary GraphQL support, whole-tree export, all account memberships, full match details or website edit coverage. The research WebView service is now implemented separately; see [research.md](research.md) for its requests, scope rules, examples and verification.
