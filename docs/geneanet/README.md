...
fam geneanet search --last-name Lincoln --first-name Abraham --category archives --page 2
fam geneanet search --last-name Martin --place Paris --event birth --from 1800 --to 1850
fam geneanet search --last-name Lincoln --spouse-last-name Todd --with-images
fam geneanet photos --last-name Lincoln --first-name Abraham
fam geneanet library --last-name Lincoln --first-name Abraham
fam geneanet library --keywords "family history"
```
...
```sh
fam geneanet search --input '{"nom":"Martin","prenom":"Jean","nom_pere":"Martin","prenom_mere":"Marie","with_variantes_nom":1,"place__0__":"Paris","size":20}'
fam geneanet search --input '{"nom":"Lincoln","categories_1[archives]":"archives","categories_2[archives#etatcivil]":"archives#etatcivil"}'
```
...
```sh
fam geneanet collections
fam geneanet collections france
fam geneanet collections north_america
fam geneanet record 'RECORD_OR_COLLECTION_URL'
fam geneanet person TREE --first-name Jane --last-name Doe
fam geneanet person TREE --index PERSON_INDEX
fam geneanet tree-media TREE PERSON_INDEX
```
...
```sh
fam geneanet tree-media TREE PERSON_INDEX
fam geneanet media DEPOSIT_ID
fam geneanet media-references DEPOSIT_ID VIEW_ID
fam geneanet download-media DEPOSIT_ID VIEW_ID --out portrait.jpg

fam geneanet record 'https://en.geneanet.org/archival-registers/view/REGISTER_ID/PAGE'
fam geneanet images REGISTER_ID --from-page 1 --to-page 10
fam geneanet download 'https://en.geneanet.org/archival-registers/view/REGISTER_ID/PAGE' --out register.jpg

fam geneanet record 'https://en.geneanet.org/library/viewer/BOOK_ID?page=PAGE'
fam geneanet download 'https://en.geneanet.org/library/viewer/BOOK_ID?page=PAGE' --out book-page.pdf
```
...
```sh
fam geneanet ops
fam geneanet schema images
fam geneanet routes media
fam geneanet routes geneweb_api
```
