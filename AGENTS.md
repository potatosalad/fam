...
- Bump package/lock versions with every change: `YYYY.MDD.N` (UTC date; daily N starts at 0).
...
- Order static provider lists (README/help) FamilySearch first, then alphabetically; rank search results by relevance.
