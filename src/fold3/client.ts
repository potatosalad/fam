...
export const operations = {
  ...
  entry:{method:'GET',path:'/fold31-image-data/sub-image/document/SUB_IMAGE/{id}',input:'{id: entryId}',description:'Read a SUB_IMAGE entry by ID or original sub-image URL, with parent scan, metadata, rectangle, and contributions. Bare IDs also found as INDEX_RECORD are rejected.'},
